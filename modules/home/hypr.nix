...
in
{
  ...
  config = lib.mkIf config.dotfiles.profiles.workstation.enable {
    xdg.configFile = {
      ...
      "hypr/adopted.d/machine.conf".source = adoptedProfiles.${config.dotfiles.hypr.adoptedProfile};
      "hypr/custom.d/00-empty.conf".source = ../../files/home/.config/hypr/custom.d/empty.conf;
      "hypr/custom.d/10-cursor.conf".source = ../../files/home/.config/hypr/custom.d/cursor.conf;
      "hypr/hyprpaper.conf".source = ../../files/home/.config/hypr/hyprpaper.conf;
      "hyprpaper/custom.d/00-empty.conf".source = ../../files/home/.config/hyprpaper/custom.d/empty.conf;
      "hyprpaper/adopted.d/00-empty.conf".source =
        ../../files/home/.config/hyprpaper/adopted.d/empty.conf;

      "mako/config".source = ../../files/home/.config/mako/config;
      "mako/custom.d/00-empty.conf".source = ../../files/home/.config/mako/custom.d/empty.conf;
      "mako/adopted.d/00-empty.conf".source = ../../files/home/.config/mako/adopted.d/empty.conf;
      "wofi/config".source = ../../files/home/.config/wofi/config;
      "eww/eww.yuck".source = ../../files/home/.config/eww/eww.yuck;
      "eww/eww.scss".source = ../../files/home/.config/eww/eww.scss;
      "eww/custom.d/00-empty.conf".source = ../../files/home/.config/eww/custom.d/empty.conf;
      "eww/adopted.d/00-empty.conf".source = ../../files/home/.config/eww/adopted.d/empty.conf;

      "hypr/custom.d/${machineProfileName}" = lib.mkIf hasHyprPromotedProfile {
    ...
    home = {
      ...
      activation = {
        ensureHyprLocalConfig = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
        ...
        configureVarietyWallpaperFolders = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
