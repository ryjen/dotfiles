...
in
{
  ...
  config = {
    ...
    # Do not manage ~/.codex/config.toml directly: Codex mutates that file for trust state.
    home.file.".config/codex/README.md".source = ../../files/home/.config/codex/README.md;
    home.file.".config/codex/local.conf.example".source = ../../files/home/.config/codex/local.conf.example;
    home.file.".config/codex/adopted.d/00-managed.conf".source = ../../files/home/.config/codex/adopted.d/00-managed.conf;
    home.file.".config/codex/custom.d/README.md".source = ../../files/home/.config/codex/custom.d/README.md;
