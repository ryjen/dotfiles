...
in
{
  ...
  config = {
    ...
    home.file.".config/codex/custom.d/.keep".source = ../../files/home/.config/codex/custom.d/.keep;
    home.file.".config/configctl/init.d/codex-config.toml".source = ../../files/home/.config/configctl/init.d/codex-config.toml;
