...
`.gitignore` can be present in packages because of this behaviour, in order to avoid having your repository cluttered with unknown files, see [example](https://github.com/ryjen/dotfiles/blob/master/sublime_text_3/.gitignore).
...
See [example](https://github.com/ryjen/dotfiles/blob/master/%40mac/%40macbook/.config/.gitconfig.sec.example).
