...
If the rtk package does not install cleanly through `uv-tools`, verify whether the package name differs from the exposed command name before moving it to another lane or adding custom package handling.
